...
class WebInterface(object):
    ...
    def config(self):
        ...
        config = {
            ...
            "rtorrent_host": headphones.CONFIG.RTORRENT_HOST,
            "rtorrent_rpc_url": headphones.CONFIG.RTORRENT_RPC_URL,
            "rtorrent_authentication": headphones.CONFIG.RTORRENT_AUTHENTICATION,
            "rtorrent_ssl": helpers.checked(headphones.CONFIG.RTORRENT_SSL),
            "rtorrent_verify": helpers.checked(headphones.CONFIG.RTORRENT_VERIFY),
            "rtorrent_username": headphones.CONFIG.RTORRENT_USERNAME,
            "rtorrent_password": headphones.CONFIG.RTORRENT_PASSWORD,
            "rtorrent_directory": headphones.CONFIG.RTORRENT_DIRECTORY,
            "rtorrent_label": headphones.CONFIG.RTORRENT_LABEL,
            "rtorrent_startonload": helpers.checked(headphones.CONFIG.RTORRENT_STARTONLOAD),
            ...
            "torrent_downloader_rtorrent": radio(headphones.CONFIG.TORRENT_DOWNLOADER, 5),
