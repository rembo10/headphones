...
def do_sorted_search(album, new, losslessOnly, choose_specific_download=False):
    ...
    TORRENT_PROVIDERS = (headphones.KAT or headphones.PIRATEBAY or headphones.T411 or headphones.MININOVA or headphones.WAFFLES or headphones.RUTRACKER or headphones.WHATCD)
    ...
    if kind == 'nzb':
        ...
        if headphones.TORRENT_DOWNLOADER == 0:
            ...
            if bestqual[2].startswith("magnet:"):
                ...
                try:
                    ...
                    if bestqual[3] == 'rutracker.org':
                        ...
                        download_path = t411.get_torrent(bestqual[2], torrent_name, headphones.TORRENTBLACKHOLE_DIR)
                        if not download_path:
                            return
                    else:
            ...
            if bestqual[3] == 'rutracker.org':
                ...
                torrent_name = helpers.replace_illegal_chars(folder_name) + '.torrent'
                file_or_url, _hash = t411.get_torrent(bestqual[2],torrent_name)
            else:
