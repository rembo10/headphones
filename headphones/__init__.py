...
def initialize():
    ...
    with INIT_LOCK:
        ...
        global __INITIALIZED__, FULL_PATH, PROG_DIR, VERBOSE, DAEMON, SYS_PLATFORM, DATA_DIR, CONFIG_FILE, CFG, CONFIG_VERSION, LOG_DIR, CACHE_DIR, \
                ...
                EMAIL_ENABLED, EMAIL_FROM, EMAIL_TO, EMAIL_SMTP_SERVER, EMAIL_SMTP_USER, EMAIL_SMTP_PASSWORD, EMAIL_SSL, EMAIL_TLS, EMAIL_ONSNATCH, \
                OSX_NOTIFY_ENABLED, OSX_NOTIFY_ONSNATCH, BOXCAR_ENABLED, BOXCAR_EMAIL, BOXCAR_APIKEY, BOXCAR_ONSNATCH, MIRRORLIST, MIRROR, CUSTOMHOST, CUSTOMPORT, CUSTOMSLEEP, \
                HPUSER, HPPASS, XBMC_ENABLED, XBMC_HOST, XBMC_USERNAME, XBMC_PASSWORD, XBMC_UPDATE, XBMC_NOTIFY, NMA_ENABLED, NMA_APIKEY, NMA_PRIORITY, NMA_ONSNATCH, \
                ...
                JOURNAL_MODE, UMASK, OSX_MOUNTAINLION, DEFAULT_TO_ALBUM_SEARCH, LOSSLESS_MIN_BITRATE, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY
