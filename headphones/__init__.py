...
def initialize():
    ...
    with INIT_LOCK:
        ...
        global __INITIALIZED__, FULL_PATH, PROG_DIR, VERBOSE, QUIET, DAEMON, SYS_PLATFORM, DATA_DIR, CONFIG_FILE, CFG, CONFIG_VERSION, LOG_DIR, CACHE_DIR, \
                ...
                TORRENTBLACKHOLE_DIR, NUMBEROFSEEDERS, KAT, KAT_PROXY_URL, PIRATEBAY, PIRATEBAY_PROXY_URL, MININOVA, T411, T411_LOGIN, T411_PASSWORD, WAFFLES, WAFFLES_UID, WAFFLES_PASSKEY, \
