...
class T411():
    ...
    def search(self, searchurl, maxsize, minseeders, albumid, bitrate):
        ...
        logger.debug(u"Search string: 1 ")
        r = self.opener.open( searchurl )
        soup = BeautifulSoup( r, "html.parser" )
        logger.debug(u"Search string: 2 ")
