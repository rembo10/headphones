...
from .._viewmodel import OptionBase, OptionString, OptionNumber, OptionSwitch, OptionPassword, OptionBool, OptionPath, OptionList, OptionDropdown, OptionUrl
...
def reg(tabname, register_block_cb, register_options_cb):
    ...
    register_block_cb(tabname,
        Block('usenet2', caption=_("Usenet2"), options=register_options_cb(
    ...
    register_block_cb(tabname,
        Block('usenet3', caption=_("Usenet3"), options=register_options_cb(
    ...
    register_block_cb(tabname,
        Block('usenet_common', caption=_("Usenet Common"), options=register_options_cb(
