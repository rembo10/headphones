...
def reg(tabname, register_block_cb, register_options_cb):
    ...
    # =======================================================================================
            ...
            OptionNumber('MAGNET_LINKS', 'General', 0,
                label=_('zzMAGNET_LINKSzz'),
                caption=_(''),
                tooltip=_(''),
                minvalue=None,
                maxvalue=None
            ...
            OptionNumber('OPEN_MAGNET_LINKS', 'General', 0,
                label=_('zzOPEN_MAGNET_LINKSzz'),
                caption=_(''),
                tooltip=_(''),
                minvalue=None,
                maxvalue=None
            ...
            OptionString('TRANSMISSION_HOST', 'Transmission', '',
                label=_('zzTRANSMISSION_HOSTzz'),
                caption=_(''),
                tooltip=_(''),
                maxlength=None
            ),
            OptionString('TRANSMISSION_PASSWORD', 'Transmission', '',
                label=_('zzTRANSMISSION_PASSWORDzz'),
                caption=_(''),
                tooltip=_(''),
                maxlength=None
            ),
            OptionString('TRANSMISSION_USERNAME', 'Transmission', '',
                label=_('zzTRANSMISSION_USERNAMEzz'),
                caption=_(''),
                tooltip=_(''),
                maxlength=None
            ),
            ...
            OptionString('UTORRENT_LABEL', 'uTorrent', '',
                label=_('zzUTORRENT_LABELzz'),
                caption=_(''),
                tooltip=_(''),
                maxlength=None
            ),
            OptionString('UTORRENT_PASSWORD', 'uTorrent', '',
                label=_('zzUTORRENT_PASSWORDzz'),
                caption=_(''),
                tooltip=_(''),
                maxlength=None
            ),
            OptionString('UTORRENT_USERNAME', 'uTorrent', '',
                label=_('zzUTORRENT_USERNAMEzz'),
                caption=_(''),
                tooltip=_(''),
                maxlength=None
            ),
